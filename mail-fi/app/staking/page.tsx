...
export default function StakingPage() {
  ...
  const getTierName = (amount: number): string => {
    if (amount >= 50000) return '=Ž Diamond'
    if (amount >= 10000) return '>G Gold'
    if (amount >= 1000) return '>H Silver'
    return '>I Bronze'
  }
        ...
        {publicKey && (
          <>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8">
              <h2 className="text-2xl font-bold mb-6">=Ê Staking Tiers & Rewards</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-blue-100 to-purple-200 rounded-xl p-6">
                  <div className="text-2xl mb-2">=Ž</div>
              ...
              <div className="mt-8 p-6 bg-gray-50 rounded-lg">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
                  ...
                  <li>Higher amounts unlock better tier rewards (Bronze ’ Diamond)</li>
