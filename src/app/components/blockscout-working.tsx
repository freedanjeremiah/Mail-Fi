...
import { WagmiWalletConnect, WagmiWalletStatus } from './wagmi-wallet-connect';

export function BlockscoutWorking() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const txResponse = await fetch(`https://eth-sepolia.blockscout.com/api/v2/addresses/${address}/transactions?page=1&limit=10`);
      console.log('Transaction response status:', txResponse.status);
      ...
      // Fetch address info
      const addrResponse = await fetch(`https://eth-sepolia.blockscout.com/api/v2/addresses/${address}`);
      console.log('Address response status:', addrResponse.status);
      ...
      if (addrResponse.ok) {
        ...
        console.error('Failed to fetch address info:', addrResponse.statusText);
      }
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1 text-left">
              ...
              <li>• Address balance and analytics</li>
              <li>• Transaction notifications</li>
              <li>• Full Blockscout integration</li>
            </ul>
          </div>
        </div>
      </div>
